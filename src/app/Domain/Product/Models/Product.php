...
use App\Domain\Product\ModelFilters\ProductFilter;
use App\Domain\Product\Models\Traits\HasDiscounts;
use App\Domain\Product\Database\Factories\ProductFactory;
use Eloquent;
...
class Product extends Model
{
    ...
    public function provideFilter($filter = null): string
    {
